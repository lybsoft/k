...
GCC_COMP=$HOME/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-
# directory containing 32bit cross-compiler (COMPAT_VDSO)
GCC_COMP_32=$HOME/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-
...
BUILD_KERNEL() {
	...
	TIMESTAMP1=$(date +%s)
	while ! make -C "$RDIR" O=$BDIR -j8; do
